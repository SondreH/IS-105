...
const ASCIIExt = "\x80\x81\x82\x83\x84\x85\x86\x87\x88\x89\x8A\x8B\x8C\x8D\x8E\x8F\x90\x91\x92" +
...
const GreetASCII = "\x22\x53\x61\x6C\x75\x74\x2C\x20\xC7\x61\x20\x76\x61\x20\xB0\x2D\x29\x20\x80\x35\x30\x22\n" //GreetASCII 
...
func GreetingExtASCII(sl string) {
	//Reeeee
	for i := 0; i < len(sl); i++ {
		fmt.Printf("%c", sl[i])
	}
