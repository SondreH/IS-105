...
// Kode for Oppgave 3c
// Vi bruk strengen fra filen treasure.txt som in-data for denne koden
...
//PrintTreasureUT8. Vi har da valgt å lage litt spesielle koder for å forstå det norske språket.
func Replace() {
