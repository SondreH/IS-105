...
func Bubble_sort_modified(list []int) {
	arrayStorrelse := len(list)
	for for1 := 0; for1 < arrayStorrelse; for1++ {
		for for2 := 0; for2 < arrayStorrelse-for2-1; for2++ {
			if list[for2] > list[for2+1] {
				list[for2], list[for2+1] = list[for2+1], list[for2]
			}
		}
	}
}
